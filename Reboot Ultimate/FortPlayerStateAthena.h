...
struct FDeathInfo
{
	...
	bool& IsInitialized()
	{
		static auto bInitializedOffset = FindOffsetStruct("/Script/FortniteGame.DeathInfo", "bInitialized");
		return *(bool*)(__int64(this) + bInitializedOffset);
	}
...
{
public:
	static inline void (*ServerSetInAircraftOriginal)(AFortPlayerStateAthena* PlayerState, bool bNewInAircraft);
	...
	{
		static auto fn = FindObject<UFunction>("/Script/FortniteGame.FortPlayerStateAthena.OnRep_TeamKillScore");
		this->ProcessEvent(fn);
	}

	void OnRep_Kills()
	{
		static auto fn = FindObject<UFunction>("/Script/FortniteGame.FortPlayerStateAthena.OnRep_Kills");
		this->ProcessEvent(fn);
	}
	...
	static void ServerSetInAircraftHook(AFortPlayerStateAthena* PlayerState, bool bNewInAircraft);
